        ...
        <div className='max-w-282.75 w-full mx-auto flex flex-col items-center justify-center'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5 lg:gap-9 mt-[57.65px] justify-items-center'>
                {PLANS.map((plan, index) => (
                    ...
                    <div key={index} className='group relative overflow-hidden w-88.25 rounded-[10px] border border-light-gray bg-white pt-[30.54px] pb-[18.14px] px-[42.55px] flex flex-col min-h-138 transition-all duration-500 hover:border-transparent hover:border-none hover:bg-[linear-gradient(90.79deg,#994FFF_0.27%,#4AB6FE_98.57%),linear-gradient(224.77deg,#E939D9_2.18%,#2ABAE9_111.89%)] cursor-pointer'>
                        <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 bg-[linear-gradient(90.79deg,#994FFF_0.27%,#4AB6FE_98.57%),linear-gradient(224.77deg,#E939D9_2.18%,#2ABAE9_111.89%)]"></div>
                        ...
                        <div className=' relative z-10 text-center mt-5 md:mt-[25.14px] lg:mt-[27.14px]'>
                        ...
                        <ul className=' relative z-20 mt-4.5 flex-1 space-y-4 flex flex-col pl-11'>
                        ...
                        <button className=' relative z-20 mt-[32.4px] mx-auto max-w-[267.9px] w-full h-[47.48px] rounded-[123px] font-medium text-[18px] leading-[150.39%] text-white bg-[linear-gradient(90.79deg,#994FFF_0.27%,#4AB6FE_98.57%)] group-hover:text-dark-black group-hover:bg-none group-hover:bg-white transition-all duration-500 cursor-pointer'>
                                {plan.button}
                        </button>
                    </div>
                ))}
