            ...
            <div className="max-w-285 mx-auto w-full bg-[url('/assets/featursbg.png')] bg-cover flex flex-col justify-between bg-center bg-no-repeat min-h-[789.1px] px-4 sm:px-6 lg:px-0 rounded-xl overflow-hidden">
                ...
                <div className='w-full flex flex-col lg:flex-row justify-center lg:justify-between lg:pl-10 gap-8 lg:gap-0'>
                    <div className='max-w-[420.14px] w-full mt-10'>
                        ...
                        <h3 className='font-medium mb-6 text-[40px] text-white Outfit leading-[100%] para'>Our Mission</h3>
                ...
                <div className='w-full flex flex-col-reverse lg:flex-row gap-8 lg:gap-[66.5px]'>
                    ...
                    <div className='max-w-[402.64px] w-full mt-10 lg:mt-27.5'>
                        ...
                        <h3 className='font-medium mb-6 text-[40px] text-white leading-[100%] Outfit para '>Solution</h3>
