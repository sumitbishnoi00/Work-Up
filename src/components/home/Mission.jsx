...
const Mission = () => {
  return (
    <section className="px-4 relative">
      <div className="max-w-285 mx-auto w-full bg-[url('/assets/featursbg.png')] bg-cover flex flex-col justify-between bg-center bg-no-repeat min-h-[789.1px] px-4 sm:px-6 lg:px-0 rounded-xl overflow-hidden mb-10 sm:mb-15 md:mb-20 lg:mb-[89.85px]">
        <div className="w-full flex flex-col lg:flex-row justify-center lg:justify-between lg:pl-10 gap-8 lg:gap-0">
          <div className="max-w-[420.14px] w-full mt-10">
            ...
            <h3 className="font-medium mb-6 text-[40px] text-white Outfit leading-[100%] para">
              Our Mission
            </h3>
            <Para
              para={
                "Our mission is to harness the power of AI-driven automation to empower Australian businesses. We propel all sized businesses towards success by automating financial tasks, from tax payments to bank transfers, report building. Creating an ecosystem where AI acts as the autopilot for finance. Join us in building a future where businesses thrive effortlessly and reach new heights."
              }
              vari="sec"
            />
          </div>
          <img
            ...
            className="w-140.25 h-95.25 object-cover rounded-xl"
            alt="Our Mission"
          />
        </div>
        ...
        <div className="w-full flex flex-col-reverse lg:flex-row gap-8 lg:gap-[66.5px]">
          ...
          <div className="max-w-[402.64px] w-full mt-10 lg:mt-27.5">
            ...
            <h3 className="font-medium mb-6 text-[40px] text-white leading-[100%] Outfit para ">
              Solution
            </h3>
            <Para
              para={
      ...
      <img
        className="w-6.25 h-[81.44px] -z-1 absolute right-0 -bottom-36.75"
        src="/assets/mitionright.webp"
        alt=""
      />
      <img
        className="w-22.75 h-[190.91px] -z-1 absolute right-0 -bottom-25"
        src="/assets/metionright.webp"
        alt=""
      />
    </section>
  );
