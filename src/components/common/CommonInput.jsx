...
const CommonInput = ({
  ...
  return (
    <div
      className={`max-w-116 w-full mx-auto border-transparent border mt-[31.06px] rounded-[100px] bg-[linear-gradient(90.79deg,#994FFF_0.27%,#4AB6FE_98.57%)] ${wrapperClass}`}
    >
      <div className=" flex items-center bg-white rounded-[100px] py-2 pl-5.5 pr-2">
        <input
          type={type}
